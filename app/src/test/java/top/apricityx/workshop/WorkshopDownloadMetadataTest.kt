...
class WorkshopDownloadMetadataTest {
    @Test
    fun readWorkshopDownloadMetadata_parsesTitleDescriptionAndPreviewUrl() {
                ...
                "publishedfiledetails": [
                  {
                    ...
                    "filename": "mod.jar",
                    "description": "[h1]Overview[/h1][list][*]First &amp; foremost[*]Second[/list]",
        ...
        assertThat(metadata?.description).isEqualTo("Overview\n\n• First & foremost\n• Second")
